        ...
        <div class="dt-sidebar__notification">
            ...
            <ul class="dt-list dt-list-xl">
                <li class="dt-list__item">
                    <a href="javascript:void(0)" class="dt-list__link" data-toggle="drawer" data-target="#drawer-list"><i class="icon icon-search icon-1x"></i></a>
                </li>
                <li class="dt-list__item">
                    <a href="javascript:void(0)" class="dt-list__link" data-toggle="drawer" data-target="#drawer-notifications"><i class="icon icon-notification2 icon-1x"></i></a>
                </li>
                <li class="dt-list__item">
                    <a href="javascript:void(0)" class="dt-list__link" data-toggle="drawer" data-target="#drawer-messages"><i class="icon icon-message icon-1x"></i></a>
                </li>
            </ul>
        </div>
        <!-- /sidebar notification -->
