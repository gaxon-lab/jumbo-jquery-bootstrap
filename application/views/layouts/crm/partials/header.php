    ...
    <div class="dt-brand">
      ...
      <span class="dt-brand__logo">
        <a class="dt-brand__logo-link" href="<?php echo site_url(); ?>">
          <img class="dt-brand__logo-img d-none d-sm-inline-block" src="<?php echo assets_url('images/logo.png');?>" alt="Drift">
        ...
        <ul class="dt-nav">
          <li class="dt-nav__item dropdown">
            ...
            <a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper"
              ...
              <img class="dt-avatar size-30" src="<?php echo assets_url('images/user-avatar/domnic-harris.jpg');?>" alt="Domnic Harris">
