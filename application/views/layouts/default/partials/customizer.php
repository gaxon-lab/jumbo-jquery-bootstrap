            ...
            <li class="dt-list__item">
              <div class="choose-option">
                <a href="javascript:void(0)" class="choose-option__icon" data-theme="light">
                  <img src="<?php echo assets_url('images/customizer/theme-light.png');?>" alt="Light">
                </a>
            ...
            <li class="dt-list__item">
              <div class="choose-option">
                <a href="javascript:void(0)" class="choose-option__icon" data-theme="semidark">
                  <img src="<?php echo assets_url('images/customizer/theme-normal.png');?>" alt="Normal">
                </a>
            ...
            <li class="dt-list__item">
              <div class="choose-option">
                <a href="javascript:void(0)" class="choose-option__icon" data-theme="dark">
                  <img src="<?php echo assets_url('images/customizer/theme-dark.png');?>" alt="Dark">
                </a>
