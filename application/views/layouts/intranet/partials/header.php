    ...
    <div class="dt-brand">
      ...
      <span class="dt-brand__logo">
        <a class="dt-brand__logo-link" href="<?php echo site_url(); ?>">
          <img class="dt-brand__logo-img d-none d-sm-inline-block" src="<?php echo assets_url('images/logo-white.png');?>" alt="Drift">
          <img class="dt-brand__logo-symbol d-sm-none" src="<?php echo assets_url('images/logo-symbol.png');?>" alt="Drift">
        </a>
      </span>
      <!-- /brand logo -->
              ...
              <div class="dropdown-menu-body ps-custom-scrollbar">
                ...
                <div class="h-auto">
                  ...
                  <a href="javascript:void(0)" class="media">
                    ...
                    <!-- Avatar -->
                    <img class="dt-avatar mr-3" src="<?php echo assets_url('images/user-avatar/stella-johnson.jpg');?>" alt="User">
                    <!-- avatar -->
                  ...
                  <a href="javascript:void(0)" class="media">
                    ...
                    <!-- Avatar -->
                    <img class="dt-avatar mr-3" src="<?php echo assets_url('images/user-avatar/jeson-born.jpg');?>" alt="User">
                    <!-- avatar -->
                  ...
                  <a href="javascript:void(0)" class="media">
                    ...
                    <!-- Avatar -->
                    <img class="dt-avatar mr-3" src="<?php echo assets_url('images/user-avatar/alex-dolgove.jpg');?>" alt="User">
                    <!-- avatar -->
              ...
              <div class="dropdown-menu-body ps-custom-scrollbar">
                ...
                <div class="h-auto">
                  ...
                  <a href="javascript:void(0)" class="media">
                    ...
                    <!-- Avatar -->
                    <img class="dt-avatar mr-3" src="<?php echo assets_url('images/user-avatar/steve-smith.jpg');?>" alt="User">
                    <!-- avatar -->
                  ...
                  <a href="javascript:void(0)" class="media">
                    ...
                    <!-- Avatar -->
                    <img class="dt-avatar mr-3" src="<?php echo assets_url('images/user-avatar/domnic-brown.jpg');?>" alt="User">
                    <!-- avatar -->
                ...
                <ul class="dt-app-list">
                    <li class="dt-app-list__item">
                        <a href="javascript:void(0)" class="dt-app-list__link">
                            <img src="<?php echo assets_url('images/icon/icon-achiever.png');?>" alt="Achiever">
                            <span class="dt-app-list__text">Achiever</span> </a>
                    </li>
                    <li class="dt-app-list__item">
                        <a href="javascript:void(0)" class="dt-app-list__link">
                            <img src="<?php echo assets_url('images/icon/icon-bookmark.png');?>" alt="Bookmark">
                            <span class="dt-app-list__text">Bookmark</span> </a>
                    </li>
                    <li class="dt-app-list__item">
                        <a href="javascript:void(0)" class="dt-app-list__link">
                            <img src="<?php echo assets_url('images/icon/icon-calculator.png');?>" alt="Calculator">
                            <span class="dt-app-list__text">Calculator</span> </a>
                    </li>
                    <li class="dt-app-list__item">
                        <a href="javascript:void(0)" class="dt-app-list__link">
                            <img src="<?php echo assets_url('images/icon/icon-camera.png');?>" alt="Camera">
                    ...
                    <li class="dt-app-list__item">
                        <a href="javascript:void(0)" class="dt-app-list__link">
                            <img src="<?php echo assets_url('images/icon/icon-compass.png');?>" alt="Compass">
                            <span class="dt-app-list__text">Compass</span> </a>
                    </li>
                    <li class="dt-app-list__item">
                        <a href="javascript:void(0)" class="dt-app-list__link">
                            <img src="<?php echo assets_url('images/icon/icon-locator.png');?>" alt="Locator">
                            <span class="dt-app-list__text">Locator</span> </a>
                    </li>
                    <li class="dt-app-list__item">
                        <a href="javascript:void(0)" class="dt-app-list__link">
                            <img src="<?php echo assets_url('images/icon/icon-message.png');?>" alt="Bottle Message">
                    ...
                    <li class="dt-app-list__item">
                        <a href="javascript:void(0)" class="dt-app-list__link">
                            <img src="<?php echo assets_url('images/icon/icon-sender.png');?>" alt="Sender">
                            <span class="dt-app-list__text">Sender</span> </a>
                    </li>
                    <li class="dt-app-list__item">
                        <a href="javascript:void(0)" class="dt-app-list__link">
                            <img src="<?php echo assets_url('images/icon/icon-shopping.png');?>" alt="Shopping">
                            <span class="dt-app-list__text">Shopping</span> </a>
                    </li>
                    <li class="dt-app-list__item">
                        <a href="javascript:void(0)" class="dt-app-list__link">
                            <img src="<?php echo assets_url('images/icon/icon-video-chat.png');?>" alt="Video Chat">
                    ...
                    <li class="dt-app-list__item">
                        <a href="javascript:void(0)" class="dt-app-list__link">
                            <img src="<?php echo assets_url('images/icon/icon-writing.png');?>" alt="Writing">
        ...
        <ul class="dt-nav">
          <li class="dt-nav__item dropdown">
            ...
            <a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper"
              ...
              <img class="dt-avatar size-50" src="<?php echo assets_url('images/user-avatar/domnic-harris.jpg');?>" alt="Domnic Harris">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <img class="dt-avatar" src="<?php echo assets_url('images/user-avatar/domnic-harris.jpg');?>" alt="Domnic Harris">
              ...
              <a class="dropdown-item" href="<?php echo site_url('pages/login'); ?>"> <i class="icon icon-editors icon-fw mr-2 mr-sm-1"></i>Logout
              </a>
            </div>
            <!-- /dropdown option -->
