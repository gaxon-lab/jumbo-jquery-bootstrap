        ...
        <div class="dt-container">
            ...
            <div class="dt-header__toolbar">
                ...
                <ul class="navbar-nav navbar-expand-lg dt-navbar d-none d-lg-flex">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-menu">
                            ...
                            <!-- Nav Item -->
                            <li class="nav-item">
                                <a href="<?php echo site_url('main/dashboard/crm'); ?>" class="nav-link">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="javascript:void(0)" class="nav-link dt-side-nav__arrow">
                                            <i class="icon icon-editors icon-fw icon-xl"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="javascript:void(0)" class="nav-link dt-side-nav__arrow">
                                            <i class="icon icon-pickers icon-fw icon-xl"></i>
                ...
                <div class="dt-nav-wrapper">
                    <!-- Header Menu -->
                    <ul class="dt-nav d-none d-lg-flex">
                        <li class="dt-nav__item">
                            <a href="<?php echo site_url('pages/layouts'); ?>" class="btn btn-secondary btn-sm ml-auto align-self-center">
                                <i class="icon icon-layout icon-fw icon-lg mr-1 d-none d-xl-inline-block"></i> <span>Layouts</span> </a>
                        </li>
                    </ul>
                    <!-- /header menu -->
                    ...
                    <ul class="dt-nav">
                        <li class="dt-nav__item dt-notification dropdown">
                            ...
                            <a href="#" class="dt-nav__link dropdown-toggle no-arrow" data-toggle="dropdown"
                               aria-haspopup="true" aria-expanded="false">
                                <i class="icon icon-notification2 icon-fw dt-icon-alert icon-xl"></i> </a>
                            <!-- /dropdown link -->
                        ...
                        <li class="dt-nav__item dt-notification dropdown">
                            ...
                            <!-- Dropdown Link -->
                            <a href="#" class="dt-nav__link dropdown-toggle no-arrow" data-toggle="dropdown"
                               aria-haspopup="true" aria-expanded="false"> <i class="icon icon-open-mail icon-fw icon-xl"></i> </a>
                            <!-- /dropdown link -->
                        ...
                        <li class="dt-nav__item dropdown">
                            ...
                            <a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="dt-avatar-info d-none">
