...
<div class="dt-sidebar-wrapper">
	<!-- Action Sidebar -->
	<div class="dt-action-sidebar">
		<!-- Action Sidebar Header -->
		<div class="dt-action-sidebar__header">
			<!-- Brand tool -->
		...
		<div class="dt-action-sidebar__container">
			<!-- Action Sidebar Menu -->
			<ul class="dt-action-nav">

				<!-- Menu Item -->
				<li class="dt-action-nav__item">
					<a href="javascript:void(0)" class="dt-action-nav__link" data-toggle="drawer" data-target="#drawer-list">
				...
				<!-- Menu Item -->
				<li class="dt-action-nav__item">
					<a href="javascript:void(0)" class="dt-action-nav__link" data-toggle="main-sidebar">
			...
			<ul class="dt-action-nav">
				...
				<li class="dt-action-nav__item dropdown">
					...
					<a href="#" class="dt-action-nav__link dropdown-toggle no-arrow"
						 data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						<img class="dt-avatar size-45" src="<?php echo assets_url('images/user-avatar/noah-owens.jpg'); ?>"
								 alt="noah-owens">
					</a>
					<!-- /dropdown link -->
	...
	<aside class="dt-sidebar">
		...
		<div class="dt-sidebar__container">
			...
			<div class="dt-sidebar__header">
				...
				<div class="dt-brand__logo">
					<a class="dt-brand__logo-link" href="<?php echo site_url(); ?>">
						<img class="dt-brand__logo-img" src="<?php echo assets_url('images/logo.png'); ?>" alt="Jumbo">
					</a>
				</div>
				<!-- /brand logo -->
			</div>
			<!-- /sidebar header -->
			<!-- Sidebar Container -->
			<div id="main-sidebar-navigation" class="dt-sidebar__navigation">
				...
				<ul class="dt-side-nav">
					...
					<li class="dt-side-nav__item">
						...
						<ul class="dt-side-nav__sub-menu">
							...
							<li class="dt-side-nav__item">
								<a href="<?php echo site_url('components/basic/button-group'); ?>"
					...
					<li class="dt-side-nav__item">
						...
						<ul class="dt-side-nav__sub-menu">
							<li class="dt-side-nav__item">
								<a href="<?php echo site_url('components/tables/basic-table'); ?>"
									 class="dt-side-nav__link">
									<i class="icon icon-tables icon-fw"></i>
					...
					<li class="dt-side-nav__item">
						...
						<ul class="dt-side-nav__sub-menu">
							<li class="dt-side-nav__item">
								<a href="<?php echo site_url('data-visualization/maps/basic'); ?>"
									 class="dt-side-nav__link">
									<i class="icon icon-maps icon-fw"></i>
							...
							<li class="dt-side-nav__item">
								<a href="<?php echo site_url('data-visualization/maps/events'); ?>"
									 class="dt-side-nav__link">
									<i class="icon icon-maps icon-fw"></i>
							...
							<li class="dt-side-nav__item">
								<a href="<?php echo site_url('data-visualization/maps/markers'); ?>"
									 class="dt-side-nav__link">
									<i class="icon icon-maps icon-fw"></i>
							...
							<li class="dt-side-nav__item">
								<a href="<?php echo site_url('data-visualization/maps/overlay'); ?>"
									 class="dt-side-nav__link">
									<i class="icon icon-maps icon-fw"></i>
							...
							<li class="dt-side-nav__item">
								<a href="<?php echo site_url('data-visualization/maps/route'); ?>"
									 class="dt-side-nav__link">
									<i class="icon icon-maps icon-fw"></i>
							...
							<li class="dt-side-nav__item">
								<a href="<?php echo site_url('data-visualization/maps/am-maps'); ?>"
									 class="dt-side-nav__link">
									<i class="icon icon-maps icon-fw"></i>
