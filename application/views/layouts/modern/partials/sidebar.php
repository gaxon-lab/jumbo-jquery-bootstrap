...
<aside id="main-sidebar" class="dt-sidebar">
  <!-- Sidebar Children -->
  <div class="dt-sidebar__children">
    <!-- Sidebar Action Bar -->
    <div class="dt-action-bar">
      <!-- Action Bar Header -->
      <div class="dt-action-bar__header">
        <!-- Brand tool -->
      ...
      <ul class="dt-action-nav">
        ...
        <li class="dt-action-nav__item">
          <a href="javascript:void(0)" class="dt-action-nav__link" data-toggle="drawer" data-target="#drawer-list"><i class="icon icon-search icon-1x"></i></a>
        </li>
        <!-- /menu item -->

        <!-- Menu Item -->
        <li class="dt-action-nav__item">
          <a href="javascript:void(0)" class="dt-action-nav__link" data-toggle="drawer" data-target="#drawer-notifications"><i class="icon icon-notification2 icon-1x"></i></a>
        </li>
        <!-- /menu item -->

        <!-- Menu Item -->
        <li class="dt-action-nav__item">
          <a href="javascript:void(0)" class="dt-action-nav__link" data-toggle="drawer" data-target="#drawer-messages"><i class="icon icon-message icon-1x"></i></a>
        </li>
        <!-- /menu item -->

        <!-- Menu Item -->
        <li class="dt-action-nav__item">
          <a href="javascript:void(0)" class="dt-action-nav__link" data-toggle="main-sidebar"><i class="icon icon-vertical-more icon-2x"></i></a>
        </li>
        <!-- /menu item -->
      ...
      <ul class="dt-action-nav">
        ...
        <li class="dt-action-nav__item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal"
               data-target="#composeModal"> <i class="icon icon-editors icon-fw"></i> Edit </a>
            <a class="dropdown-item" href="javascript:void(0)"> <i class="icon icon-trash icon-fw"></i> Delete </a>
            <a class="dropdown-item" href="javascript:void(0)"> <i class="icon icon-heart-o icon-fw"></i> Favourite List
            </a>
          </div>
          <!-- /dropdown option -->
        ...
        <li class="dt-action-nav__item dropdown">
          ...
          <a href="#" class="dt-action-nav__link dropdown-toggle no-arrow"
             data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <img class="dt-avatar size-30 ml-n1" src="<?php echo assets_url('images/user-avatar/domnic-harris.jpg');?>"
                   alt="Domnic Harris">
          </a>
          <!-- /dropdown link -->
        ...
        <div class="dt-brand">
          ...
          <span class="dt-brand__logo">
            <a class="dt-brand__logo-link" href="<?php echo site_url(); ?>">
              ...
              <img class="dt-brand__logo-symbol" src="<?php echo assets_url('images/logo-symbol.png');?>" alt="Drift">
            </a>
          </span>
          <!-- /brand logo -->
