            ...
            <div class="dt-brand">
                ...
                <span class="dt-brand__logo">
                    <a class="dt-brand__logo-link" href="<?php echo site_url(); ?>">
                        ...
                        <img class="dt-brand__logo-symbol d-sm-none" src="<?php echo assets_url('images/logo-white-symbol.png'); ?>" alt="Drift">
                    </a>
                </span>
                <!-- /brand logo -->
                ...
                <div class="dt-nav-wrapper">
                        ...
                        <li class="dt-nav__item dt-notification-search dropdown">
                            ...
                            <a href="#" class="dt-nav__link dropdown-toggle no-arrow" data-toggle="dropdown"
                               aria-haspopup="true" aria-expanded="false"> <i
                                    class="icon icon-search icon-fw icon-xl"></i> </a>
                            <!-- /dropdown link -->
                    ...
                    <ul class="dt-nav d-lg-none">
                                    ...
                                    <div class="h-auto">
                                        ...
                                        <a href="javascript:void(0)" class="media">
                                            ...
                                            <img class="dt-avatar mr-3"
                                                 src="<?php echo assets_url('images/user-avatar/stella-johnson.jpg'); ?>" alt="User">
                                            <!-- avatar -->
                                        ...
                                        <a href="javascript:void(0)" class="media">
                                            ...
                                            <!-- Avatar -->
                                            <img class="dt-avatar mr-3" src="<?php echo assets_url('images/user-avatar/selena.jpg'); ?>"
                                                 alt="User">
                                            <!-- avatar -->
                                            ...
                                            <span class="media-body">
                                                <span class="message">
                                                    <span class="user-name">Chelsea Brown</span> sent a video recommendation.
                                                </span>
                        ...
                        <li class="dt-nav__item dt-notification dropdown">
                            ...
                            <a href="#" class="dt-nav__link dropdown-toggle no-arrow" data-toggle="dropdown"
                               aria-haspopup="true" aria-expanded="false"> <i
                                    class="icon icon-open-mail icon-fw icon-xl"></i> </a>
                            <!-- /dropdown link -->
                                ...
                                <div class="dropdown-menu-body ps-custom-scrollbar">
                                    ...
                                    <div class="h-auto">
                                        ...
                                        <a href="javascript:void(0)" class="media">
                                            ...
                                            <!-- Avatar -->
                                            <img class="dt-avatar mr-3" src="<?php echo assets_url('images/user-avatar/mathew.jpg'); ?>"
                                                 alt="User">
                                            <!-- avatar -->
                        ...
                        <li class="dt-nav__item dropdown">
                            ...
                            <a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="dt-avatar size-50" src="<?php echo assets_url('images/user-avatar/domnic-harris.jpg'); ?>"
                                     alt="Domnic Harris">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dt-avatar-wrapper flex-nowrap p-6 mt-n2 bg-gradient-purple text-white rounded-top">
                                    <img class="dt-avatar" src="<?php echo assets_url('images/user-avatar/domnic-harris.jpg'); ?>"
                                         alt="Domnic Harris">
                                ...
                                <a class="dropdown-item" href="javascript:void(0)"> <i
                                    ...
                                    <i class="icon icon-myplan icon-fw mr-2 mr-sm-1"></i>My Plan</a>
                                <a class="dropdown-item" href="javascript:void(0)"> <i
                                        class="icon icon-settings icon-fw mr-2 mr-sm-1"></i>Setting </a>
            ...
            <div class="dt-header__toolbar d-none d-lg-flex">
                ...
                <div class="dt-nav-wrapper">
                    ...
                    <a href="<?php echo site_url('pages/layouts'); ?>" class="btn btn-secondary btn-sm ml-auto align-self-center">
                        <i class="icon icon-layout icon-fw icon-lg mr-1 d-none d-xl-inline-block"></i>
                        <span>Layouts</span> </a>
