                ...
                <div class="dt-module__header">
                    ...
                    <div class="dt-avatar-wrapper">
                        <div class="dt-avatar-status mr-2">
                            <img class="dt-avatar size-45"
                                 src="<?php echo assets_url('images/user-avatar/domnic-brown.jpg');?>"
                                 alt="Domnic Brown">
                            <div class="dot-shape bg-success dot-shape-lg"></div>
                        </div>
                        <span class="dt-avatar-info">
                            <a href="javascript:void(0)" class="dt-avatar-name">Domnic Brown</a>
                    ...
                    <div class="dt-module__content-inner">
                        ...
                        <div class="dt-chat__conversation">
                            ...
                            <div class="dt-chat__item">
                                ...
                                <!-- Avatar -->
                                <img class="dt-avatar size-30"
                                     src="<?php echo assets_url('images/user-avatar/domnic-brown.jpg');?>" alt="Domnic Brown">
                                <!-- /avatar -->
