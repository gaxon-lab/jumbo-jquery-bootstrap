...
<div class="dt-page__header">
    <h1 class="dt-page__title">Notification Alert</h1>
</div>
<!-- /page header -->
...
<div class="dt-entry__header">
    ...
    <div class="dt-entry__heading">
        <h3 class="dt-entry__title">Notification Alert</h3>
    </div>
    <!-- /entry heading -->
...
<div class="dt-entry__header">
    ...
    <!-- Entry Heading -->
    <div class="dt-entry__heading">
        <h3 class="dt-entry__title">Notification Alert With Position</h3>
    </div>
    <!-- /entry heading -->
