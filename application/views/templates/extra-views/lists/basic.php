                ...
                <div class="d-sm-flex flex-sm-row">
                    ...
                    <div class="min-w-120">
                        <a href="javascript:void(0)"
                           class="btn btn-primary text-uppercase btn-block">Hire me</a>
                        <a href="javascript:void(0)"
                           class="btn btn-outline-light text-light-gray text-uppercase btn-block">
                            <i class="icon icon-star-o icon-fw"></i> <span>Save</span>
                        </a>
                    </div>
        ...
        <div class="dt-card">
            ...
            <div class="dt-card__body">
                ...
                <div class="d-sm-flex flex-sm-row">
                    ...
                    <!-- User Avatar-->
                    <img class="dt-avatar size-60 mr-sm-6 mb-6 mb-sm-0"
