...
(function ($) {
    ...
    if ($('#main-sidebar').length) {
        var leftSideBarScroll = new PerfectScrollbar('#main-sidebar', {
          wheelPropagation: !docBody.hasClass('dt-sidebar--fixed')
        });
        
        $(document).on('sidebar-toggle-fixed', function () {
            leftSideBarScroll.settings.wheelPropagation = !docBody.hasClass('dt-sidebar--fixed');
    ...
    $sidebar.hover(function () {
        if (docBody.hasClass('dt-sidebar--folded')) {
            docBody.addClass('dt-sidebar--expended');
        }
    }, function () {
        if (docBody.hasClass('dt-sidebar--folded')) {
            docBody.removeClass('dt-sidebar--expended');
        }
    });
    /* /Sidebar */
    ...
    $mailContacts.each(function (index) {
        ...
        $contact.hover(function (event) {
            ...
            var bodyHeight = docBody.outerHeight(true);
            var bodyWidth = docBody.outerWidth(true);
